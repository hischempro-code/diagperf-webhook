// ====== Email config ======
const EMAIL_FROM = process.env.EMAIL_FROM || '"Diagperf" <diag.perf.pro@gmail.com>';
const EMAIL_REPLY_TO = "Diag.perf.pro@gmail.com";

let _transporter = null;
let _log = null;

function initEmailService({ transporter, log }) {
...
async function sendQuoteEmail({ to, devis }) {
  ...
  try {
    await _transporter.sendMail(msg);
