...
- Déplacement : DiagPerf N'intervient PAS à domicile. Toutes les prestations se font UNIQUEMENT à l'atelier de Villenoy (77124). Ne jamais suggérer de déplacement, d'intervention groupée, de partenariat local ou d'optimisation de trajet.
...
- JAMAIS suggérer de déplacement, intervention à domicile, intervention groupée, partenariat local, ou déplacement optimisé — DiagPerf travaille uniquement en atelier
...
💡 Devis gratuit et sans engagement.`;
    ...
    // Récupération partielle : si type manquant mais message présent → inférer type:"answer"
