...
{ "type": "answer", "message": "Ta réponse", "final": true }   ← ajoute "final": true UNIQUEMENT si c'est une fin naturelle de sujet (remerciement client, invitation claire à revenir au menu, ou sujet entièrement clos)
⚠️ "Combien coûte X ?" / "C'est quoi X ?" / "Quelle durée ?" = TOUJOURS Cas 2, jamais Cas 1.
⚠️ Sans "final": la réponse sera envoyée en texte simple pour laisser la conversation continuer.
⚠️ Avec "final": true : un bouton "Menu" sera ajouté automatiquement.
...
⚠️ N'ajoute JAMAIS "final": true sur un message de suivi — laisse la conversation se poursuivre.
