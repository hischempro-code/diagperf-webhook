---
category: faq
tags: [slang, informel, argot, whatsapp, jeune, langage, courant, symptomes, panne, mecanique]
---

# Expressions informelles et variantes de questions

## "Ça coûte combien une reprog ?"
Reprogrammation Stage 1 : 390€ TTC pour les véhicules de moins de 400ch et avant 2018. Pour les véhicules plus puissants ou plus récents, c'est sur devis personnalisé. Le devis est gratuit et sans engagement.

## "Vous prenez quel type de voiture ?"
...
## "Elle fume noir" / "fumée noire au pot"
La fumée noire sur un diesel indique souvent une combustion incomplète : FAP saturé, injecteurs usés ou EGR encrassé. On commence par un diagnostic pour identifier la source avant de proposer une solution.

## "Mon FAP est niqué / bouché / colmaté"
Si ton FAP est complètement saturé et ne régénère plus, deux options : tentative de régénération forcée ou suppression logicielle FAP (260€ avant 2019, 300€ après). On diagnostique d'abord pour confirmer.

## "Mode dégradé" / "mode de limp" / "bride"
Le mode dégradé est déclenché par le calculateur pour protéger le moteur (FAP, turbo, EGR, AdBlue...). Un diagnostic permettra de lire le code défaut exact et de cibler la panne.

## "Elle tire vers la droite / gauche" / "problème de géométrie"
Les problèmes de géométrie ou d'alignement ne font pas partie de nos prestations. On se concentre sur la partie électronique/cartographie. Pour la géométrie, rapproche-toi d'un spécialiste pneumatique.

## "Elle consomme trop" / "trop gourmande en carburant"
Une surconsommation peut venir d'un FAP encrassé, d'une sonde lambda défaillante ou d'une cartographie sous-optimale. La conversion E85 peut aussi réduire ta facture d'environ 40€/mois. Un diagnostic de 50€ peut déjà donner des pistes.

## "Mon turbo siffle" / "bruit turbo" / "souffle turbo"
Un sifflement anormal du turbo peut indiquer une fuite de suralimentation ou un turbo en fin de vie. Avant toute reprog, on recommande un diagnostic complet (130€) pour s'assurer que le turbo est sain.

## "Perte de puissance" / "moins de pêche" / "elle tire plus"
Une perte de puissance sur diesel peut venir du FAP, de l'EGR, du turbo ou d'un injecteur. Sur essence, souvent une sonde lambda ou un capteur de cliquetis. Un diagnostic d'abord, puis on avise.

## "Mon AdBlue fait des problèmes" / "erreur AdBlue" / "niveau AdBlue"
